...
module Ntp
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['NTP_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Ntp::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Ntp::Action is included
      ...
      # Configure the code that will yield each time Ntp::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Ntp::Assets::Helpers
      end
    end
